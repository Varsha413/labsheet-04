...
sample1$AgeGroup<-ifelse(sample1$Age<18,"Minor",ifelse(sample1$Age<=60,"Adult","Senior"))
sample1$IncomeCategory<-ifelse(sample1$Income<30000,"Low",ifelse(sample1$Income<=60000,"Medium","High"))
